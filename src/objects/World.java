...
public class World extends JPanel implements Observer {
	...
	protected final String BACKGROUND_IMAGE = "src/resources/background_tile.png";

	protected final String TANK_IMAGE = "src/resources/Tank_grey_basic.png";
	...
	public World(GameFrame frame) {
		...
		try {
			...
			Image tank1 = ImageIO.read(new File("src/resources/Tank_blue_basic_strip60.png"));

			Image tank2 = ImageIO.read(new File("src/resources/Tank_red_basic_strip60.png"));
			...
			Image wallImage = ImageIO.read(new File("src/resources/wall.png"));
	...
	public void drawFrame(int w, int h, Graphics2D graphics) {
		...
		for (Wall wall : walls) {
			...
			int wallWidth = wall.image.getWidth(null) + 1;

			int wallHeight = wall.image.getHeight(null) + 1;
		...
		System.out.println(
				...
				"Tank1: noTankCollision: " + noTankCollision + " noTank1WallCollision: " + noTank1WallCollision);

		System.out.println("Tank1: noTankCollisionNextMove: " + noTankCollisionNextMove

				+ " noTank1WallCollisionNextMove: " + noTank1WallCollisionNextMove);
		...
		System.out.println(
				...
				"Tank2: noTankCollision: " + noTankCollision + " noTank2WallCollision: " + noTank2WallCollision);

		System.out.println("Tank2: noTankCollisionNextMove: " + noTankCollisionNextMove

				+ " noTank2WallCollisionNextMove: " + noTank2WallCollisionNextMove);
